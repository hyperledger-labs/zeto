...
| `check_inputs_outputs_value.circom` | `powersOfTau28_hez_final_11.ptau` |
| `check_nullifier_value.circom`      | `powersOfTau28_hez_final_16.ptau` |
| `check_nullifiers.circom`           | `powersOfTau28_hez_final_11.ptau` |
| `check_smt_proof.circom`            | `powersOfTau28_hez_final_16.ptau` |
