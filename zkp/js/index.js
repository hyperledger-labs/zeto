...
const { newSalt, newEncryptionNonce, poseidonDecrypt, encodeProof, getProofHash, tokenUriHash, kycHash, getKyberCipherText, bitsToBytes, bytesToBits } = require('./lib/util.js');
