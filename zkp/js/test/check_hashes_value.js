...
describe('check_hashes_value circuit tests', () => {
  ...
  it('should return true for valid witness', async () => {
    ...
    const output2 = poseidonHash([BigInt(outputValues[1]), salt2, ...sender.pubKey]);
  ...
  it('should fail to generate a witness because of invalid output commitments', async () => {
    ...
    const output2 = poseidonHash([BigInt(outputValues[1]), salt1, ...sender.pubKey]);
    const outputCommitments = [output1, output2];
  ...
  it('should fail to generate a witness because of using the inverse of a negative value in output commitments', async () => {
    ...
    const outputValues = [21888242871839275222246405745257275088548364400416034343698204186575808495518n, 100];
